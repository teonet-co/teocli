...
//    auto ip(std::string(*String::Utf8Value(p0)).c_str());
//    auto port(std::string(*String::Utf8Value(p0)).c_str());

//    v8::Local<v8::Function> cons = Nan::New<v8::Function>(TeoErrnoExeption::constructor);
//    int arcv (3);
...
//////    info.GetReturnValue().Set(TeoErrnoExeption::createNewInstance(100, "text"));

//////    Nan::ThrowError(TeoErrnoExeption::createNewInstance(100, "text"));
