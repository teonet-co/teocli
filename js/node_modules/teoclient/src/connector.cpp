...
NAN_METHOD(Connector::Send) {
    ...
    auto This(Nan::ObjectWrap::Unwrap<Connector>(info.Holder()));
    std::lock_guard<std::mutex> lock(This->get_connector_mutex());
...
NAN_METHOD(Connector::New) {
    ...
    std::lock_guard<std::mutex> lock(object->get_connector_mutex());
