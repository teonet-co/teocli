...
extern void AGo_event_cb(void *con, teoLNullEvents event, void *data,
            size_t data_len, void *user_data);

teoLNullConnectData* AC_teoLNullConnectE(const char *server, int port,
	void *user_data) {
	return teoLNullConnectE(server, port, AGo_event_cb, user_data);
}

void AC_event_cb(void *con, teoLNullEvents event, void *data,
            size_t data_len, void *user_data) {
		AGo_event_cb(con, event, data, data_len, user_data);
}
