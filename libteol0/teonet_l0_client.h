...
typedef void (*teoLNullEventsCb)(void* kc, teoLNullEvents event, void* data, size_t data_len,
                                 void* user_data);
...
typedef struct ksnet_arp_data {
  ...
  int16_t mode; ///< Peers mode: -1 - This host, -2 undefined host, 0 - peer , 1 - r-host, 2 - TCP
                ///< Proxy peer
